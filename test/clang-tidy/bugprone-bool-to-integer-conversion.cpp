...
struct B : A {
  int fun() {
    // CHECK-MESSAGES: :[[@LINE-1]]:7: warning: function has return type 'int' but returns only bools
    return true;
    // CHECK-MESSAGES: :[[@LINE-1]]:12: note: converting bool to 'int' here
  }

  int fun2() { return true; }
  // CHECK-MESSAGES: :[[@LINE-1]]:7: warning: function has return type 'int' but returns only bools
  // CHECK-MESSAGES: :[[@LINE-2]]:23: note: converting bool to 'int' here
  // CHECK-FIXES: bool fun2() {
};
